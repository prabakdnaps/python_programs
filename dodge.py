...
while noOfTry>0:
	time.sleep(1)
	element=wd.find_element_by_id("company-select-all")
	element.click()
	time.sleep(1)
	element=wd.find_element_by_id("ctl00_contentPlaceHolderHeader_Actions_btnCompanyActions")
	element.click()
	time.sleep(1)
	element=wd.find_element_by_id("ctl00_contentPlaceHolderHeader_Actions_liDownloadCompanies")
	element.click()
	time.sleep(2)
	...
	element.click()
	time.sleep(1)
	element=wd.find_element_by_id("ctl00_contentPlaceHolderHeader_CompanyResult_pagerTop_Next")
	element.click()
	time.sleep(1)
	noOfTry=noOfTry-1
